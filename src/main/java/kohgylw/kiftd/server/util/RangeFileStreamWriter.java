...
//		return writeRangeFile(request, response, fo, fname, contentType, maxRate, eTag, isAttachment, true);
        try {
            return writeToFile(request, response, fo, fname, contentType, maxRate, eTag, isAttachment, true);
        } catch (Exception e) {
...
//		return writeRangeFile(request, response, fo, fname, contentType, -1, eTag, isAttachment, false);
        return writeToFile(request, response, fo, fname, contentType, -1, eTag, isAttachment, false);
    }

    public static int writeToFile(HttpServletRequest request, HttpServletResponse response, File fo, String fname, String contentType, long maxRate, String eTag, boolean isAttachment, boolean sendBody) {
        FileServiceHandler fileServiceHandler = new FileServiceHandler(request, response, fo, fname,
                contentType, maxRate, eTag, isAttachment, sendBody);
        fileServiceHandler.run();
        return fileServiceHandler.getStatus();
    }
